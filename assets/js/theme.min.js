...
var Navbar = function() {
	...
	Menu = function() {
		...
		e.length && e.each(function() {
			...
			t.preventDefault();
			var n, s, o, l, i = $(this);
			n = i, s = e.filter(n.attr("href")), o = n.data("filter"), s.isotope({
				filter: o
			}), (l = i).parent("li").siblings("li").removeClass("active"), l.parent("li").addClass("active")
		})
	}(),
	Events = function() {
		...
		n.on("click", function() {
			var n;
			(n = $(this)).closest(e).find(t).removeClass("active"), n.closest(t).addClass("active")
		})
	}(),
	Gallery = function() {
		...
		e.on("submit", function(t) {
			t.preventDefault(), $.ajax({
				...
				success: function(t) {
					...
					} else $(document).trigger("touche.alert.show", ["success", t.msg]), e[0].reset()
				}
			})
		}), n.on("submit", function(t) {
			t.preventDefault(), e && e.submit()
		}), s.on("keyup", function() {
			! function() {
				if (t.length) {
					var e = s.val();
	...
	GoogleMap = function() {
		...
		e.length && e.each(function() {
			...
			a.open(l, i), google.maps.event.addListener(a, "closeclick", function() {
				i.setVisible(!0)
			})
		})
	}(),
